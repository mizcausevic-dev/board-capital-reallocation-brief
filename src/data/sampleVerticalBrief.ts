...
export const sampleBoardCapitalReallocationBrief: BoardCapitalReallocationItem[] = [
  {
    ...
    requiredEvidence: ["Procurement OS", "Questionnaire answer studio", "Trust center evidence room", "Vendor proof gap monitor"]
  },
  {
    ...
    requiredEvidence: ["AI governance scorecard", "Executive board brief", "Procurement-ready proof set"]
  },
  {
    ...
    requiredEvidence: ["Identity risk ledger", "Access review posture", "Remediation queue proof"]
  },
  {
    ...
    requiredEvidence: ["Platform margin leak report", "Revenue infrastructure scorecard", "Benchmark waterfall"]
  },
  {
    ...
    requiredEvidence: ["Investor diligence pack", "Treasury signal lab", "Merchant review posture", "KYC queue evidence", "Vendor replacement intelligence"]
  },
  {
    ...
    requiredEvidence: ["Change control board", "CAPA ledger", "Specimen custody proof", "Safety signal router"]
  }
];
